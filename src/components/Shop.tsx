    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-[13px] leading-snug font-semibold">{item.label}</h3>
          {item.note ? (
  ...
  return (
    <>
      ...
      <p className="mt-4 text-[11px] text-ink-3">
        ...
        s&apos;épuise pas. Les 🎁 coffres, eux, tirent au sort une récompense de
        leur palier — statistiquement plus chère que le coffre lui-même.
      </p>
    </>
  );
}
